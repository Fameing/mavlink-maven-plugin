...
public class MessageGenerator {
    private static ClassName MAVLINK_MESSAGE_INFO;
    private static ClassName MAVLINK_MESSAGE_BUILDER;
    ...
    public MessageGenerator(
        ...
        MAVLINK_MESSAGE_INFO = ClassName.get(
                basePackage + ".annotations",
                "MavlinkMessageInfo");

        MAVLINK_MESSAGE_BUILDER = ClassName.get(
                basePackage + ".annotations",
